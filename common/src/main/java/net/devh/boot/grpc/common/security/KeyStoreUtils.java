...
public final class KeyStoreUtils {
    ...
    /**
     * Creates a new {@link KeyManagerFactory} from the given {@link KeyStore} {@link File}.
     *
    ...
    /**
     * Creates a new {@link TrustManagerFactory} from the given {@link KeyStore} {@link File}.
     *
    ...
    /**
     * Loads the {@link KeyStore} from the given {@link File}.
     *
     * @param keyStoreFormat The format of the keystore.
     * @param keyStore The resource containing the keystore.
     * @param keyStorePassword The password for the keystore. May be empty or null.
    ...
    private static KeyStore loadKeyStore(
        ...
        final String detectedFormat = detectFormat(keyStoreFormat, keyStore.getName());
